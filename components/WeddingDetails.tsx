  ...
  return (
    <section className="py-8 md:py-16 px-4 bg-gradient-to-b from-background to-secondary/10">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="text-md md:text-2xl text-foreground mb-2">
            Gửi đến tất cả những người bạn thân thương nhất của chúng mình,
          </div>
          <div className="text-md md:text-2xl text-foreground mb-2">
        ...
        >
          ...
          <div className="mb-6">
            <div className="flex items-center justify-center gap-4 md:gap-8 mb-2">
              <span className="text-2xl md:text-2xl text-primary font-semibold">Ngày 10 Tháng 1 năm 2026</span>
              {/* <span className="text-4xl md:text-5xl text-primary font-bold">Tháng 1</span>
